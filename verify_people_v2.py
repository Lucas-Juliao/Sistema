...
async def run():
    async with async_playwright() as p:
        ...
        # Navigate to Pessoas
        await page.goto("http://127.0.0.1:5000/people")
        ...
        await page.screenshot(path="/home/jules/verification/people_add_aluno.png")

        # Check the guardian checkbox
        await page.check('#addHasGuardian')
        await asyncio.sleep(0.3)
        await page.screenshot(path="/home/jules/verification/people_guardian_fields.png")
        ...
        await page.screenshot(path="/home/jules/verification/people_phone_mask.png")

        # Switch to Professor and check if Guardian section disappears
        await page.select_option('select[name="type"]', value="teacher")
        await asyncio.sleep(0.3)
        await page.screenshot(path="/home/jules/verification/people_teacher_no_guardian.png")

        # Close modal and filter to see ID
        await page.click(".close-custom")
        await page.click("#filterBtn")
        await asyncio.sleep(0.5)
        await page.screenshot(path="/home/jules/verification/people_table_with_id.png")
