...
async def run():
    async with async_playwright() as p:
        ...
        # Navigate to Agenda
        await page.goto("http://127.0.0.1:5000/schedule")
        ...
        await page.screenshot(path="/home/jules/verification/schedule_add_modal_with_room.png")
        ...
        await page.screenshot(path="/home/jules/verification/schedule_table_with_room.png")
